...
description: Investment memo consolidating all research artifacts into a single decision document
word_cap: 3000
---
...
Prioritized list of actions to derisk the investment or reach conviction. E.g., founder reference calls, customer interviews, technical deep dive, competitive analysis.
...
What changed since the previous round: new information discovered, assumptions validated or invalidated, risks that materialized or were mitigated, direction shifts.
